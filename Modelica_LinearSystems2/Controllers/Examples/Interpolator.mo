...
model Interpolator "Demonstrate usage of Interpolator"
  ...
  inner SampleClock sampleClock(sampleTime=0.001, blockType=
        Modelica_LinearSystems2.Controllers.Types.BlockType.Discrete)
    annotation (Placement(transformation(extent={{-80,60},{-60,80}})));
  Modelica_LinearSystems2.Controllers.Interpolator interpolator1(
    outputSampleFactor=4,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Continuous,
    meanValueFilter=false,
    inputSampleFactor=20)
    annotation (Placement(transformation(extent={{0,40},{20,60}})));

  Modelica_LinearSystems2.Controllers.Interpolator interpolator2(
    outputSampleFactor=4,
  ...
  Modelica_LinearSystems2.Controllers.Interpolator interpolator3(
    outputSampleFactor=4,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
    inputSampleFactor=20)

...
model SimpleControlledDrive
  ...
  inner SampleClock sampleClock(sampleTime=0.005, blockType=
    Modelica_LinearSystems2.Controllers.Types.BlockType.Continuous)
  ...
  Filter filter(
    ...
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete) annotation (Placement(transformation(extent={{-71,20},{-51,40}})));
